...
namespace Loadouts
{
    //todo: make it so that you can rename loadouts
    //todo: change console color to be the same as the main color of the mod
    public static class Loadouts
    {
        ...
        private static readonly string LoadoutPath = Path.Combine(MelonUtils.UserDataDirectory, "Loadouts");
        ...
        public static void BoneMenuCreator()
        {
            ...
            Category = MenuManager.CreateCategory( //TODO: Chnage this to be good
                "<color=#00FF72>Loadouts</color>" +
            ...
            _loadouts = Category.CreateCategory("Loadouts", "#ff4060");
